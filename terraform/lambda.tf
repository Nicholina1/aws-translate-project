...
resource "aws_lambda_layer_version" "lambda_layer" {
  ...
  layer_name = "translate_dependencies_layer"
...
data "archive_file" "lambdafiles" {
  ...
  source {
    content  = file("${path.module}/../scripts/lambda_function.py")
    filename = "lambda_function.py"
  }

  source {
    content  = file("${path.module}/../scripts/translation_app.py")
